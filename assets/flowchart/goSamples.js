...
if (window.require) {
  ...
  document.write('<script src="assets/flowchart/highlight.js"></script>');
  window.jQuery || document.write('<script src="assets/flowchart/jquery.min.js"></script>'); // 1.11.3
  document.write('<script src="assets/flowchart/bootstrap.min.js"></script>');
}
...
link.type = "text/css";
link.rel = "stylesheet";
link.href = "assets/flowchart/bootstrap.min.css";
head.appendChild(link);

link = document.createElement("link");
link.type = "text/css";
link.rel = "stylesheet";
link.href = "assets/flowchart/highlight.css";
head.appendChild(link);

link = document.createElement("link");
link.type = "text/css";
link.rel = "stylesheet";
link.href = "assets/flowchart/main.css";
head.appendChild(link);
...
function goSamples() {
  ...
  document.body.insertBefore(samplediv, container);
