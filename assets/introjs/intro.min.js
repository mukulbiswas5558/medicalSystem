...
(function (root, factory) {
  ...
  */
  ...
  function _scrollTo(scrollTo, targetElement, tooltipLayer) {
    ...
    if (typeof(targetElement.jsfunction) != "undefined") {
        eval(targetElement.jsfunction);
    ...
    if (scrollTo === 'tooltip') {
      ...
      var rect = targetElement.element.getBoundingClientRect();
        ...
        /*if (typeof(targetElement.jsfunction) != "undefined") {
            console.log(targetElement.element.id);
            if (typeof(targetElement.element.id) != "undefined")
                rect.top = $('#' + targetElement.element.id).offset().top;
        }*/
